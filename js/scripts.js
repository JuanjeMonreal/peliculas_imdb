        ...
        success: function(result){
           ...
           for(var item=0; item<lista_peliculas.length; item++){
                ...
                $( "#listado_peliculas" ).append(
                    '<div class="col-12 col-sm-6 col-md-4 col-xl-3 card-all">' +
                        '<div class="card mt-3">' +
                          ...
                          '<div class="card-body">' +
                            ...
                            '<a href="#" class="btn btn-primary boton_info" referencia_oculta="peli'+item+'">Leer más...</a>' +
                          '</div>' +
                        '</div>' +
                    '</div>');
                    ...
                    $( "#info_peliculas" ).append(
                        ...
                        "<p>"+pelicula_actual.overview+"</p>" +
                          '<img class="imagen2" src="' + backdrop_path + pelicula_actual.backdrop_path + '" class="card-img-top img_card" alt="...">' +
                          "</div>"
                        );
